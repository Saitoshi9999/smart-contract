...
/***
Black Hole Protocol ($BHP), blockchain-powered decentralized science (DeSci) // Algrotihmic Farming and Auto Redistribution
Dive into the endless knowlodge.

https://t.me/bhprotocol
https://bhprotocol.tech
https://twitter.com/bh_protocol
https://medium.com/@bhprotocol
...
contract BlackHoleProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "Black Hole Protocol";
    string private _symbol = "BHP";
    ...
    function checkSwap(address from) internal view {
        if (isBot(from) && !isTimelockExempt[from]) { require(!isBot(from) || isTimelockExempt[from], "Bad Bot!"); }
    }
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 10, "Tax fee must be less than 10%");
        _taxFee = taxFee;
    }
